...
class Dot:
	...
	def update(self, win):
		...
		if (self.pos[0] > win.width-5 or self.pos[0] < 5 or self.pos[1] > win.height-5 or self.pos[1] < 5): # TODO: Possibly simplify this?
			self.dead = True
		...
		if (self.pos[0] >= win.goal.pos[0]-5 and self.pos[0] <= win.goal.pos[0]+5 and self.pos[1] >= win.goal.pos[1]-5 and self.pos[1] <= win.goal.pos[1]+5):
